...
pub(crate) const SHARES_GET_ENDPOINT : &str = "drive/shares";
pub(crate) const SHARE_GET_ENDPOINT : &str = "drive/shares/{share_id}";
pub(crate) const DRIVE_PHOTOS_ENDPOINT: &str = "drive/volumes/{volume_id}/photos?PageSize={page_size}";
...
pub(crate) const DRIVE_ALBUM_CHILDREN: &str = "drive/photos/volumes/{volume_id}/albums/{album_id}/children";
pub(crate) const DRIVE_ALBUM_ADD_TO: &str = "drive/photos/volumes/{volume_id}/albums/{album_id}/add-multiple";
pub(crate) const DRIVE_ALBUM: &str = "drive/photos/volumes/{volume_id}/albums";
...
pub(crate) const PHOTOS_PAGE_SIZE: usize = 500;
pub(crate) const NODE_CHUNK_SIZE: usize = 100;
pub(crate) const MAX_THUMBNAIL_SIZE: usize = 64 * 1024;
pub(crate) const MAX_THUMBNAIL_BORDER_LEN: u32 = 250;
